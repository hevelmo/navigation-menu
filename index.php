...
>>>>>>> Stashed changes
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 results-container">
                            <div class="results-container-in">
                                <div class="view-results-list">
                                    <div id="results-holder" class="results-grid-view">
                                        <!-- Result Item -->
                                        <div class="result-item format-standard">
                                            <a class="views-details views-details-size bg-views-details views-details-transition">
        ...
        <style>
            ...
            .result-item:hover .views-details {
                overflow: visible;
                opacity: 1;
            }
            .result-item:hover .views-details.views-details-size {
                height: 16%;
            }
            .views-details span {
                color: #fff;
            ...
            .result-item:hover .views-details span {
                overflow: visible;
                opacity: 1;
                text-indent: 0px;
                font-size: 1em;
                ...
                -webkit-transition-duration: 555ms;
                -moz-transition-duration: 555ms;
                -ms-transition-duration: 555ms;
                -o-transition-duration: 555ms;
            }
            .views-details.bg-views-details {
                background: rgba(35, 33, 33, 0.7);
            }
            .views-details.views-details-transition,
            .views-details span {
                -webkit-transform-timing-function: ease-out;
                -moz-transform-timing-function: ease-out;
                -ms-transform-timing-function: ease-out;
            ...
            .result-item:hover {
                -webkit-transform: scale(1.012,1.012);
                -moz-transform: scale(1.012,1.012);
                -ms-transform: scale(1.012,1.012);
                -o-transform: scale(1.012,1.012);
                -webkit-transform-timing-function: ease-out;
                -moz-transform-timing-function: ease-out;
                -ms-transform-timing-function: ease-out;
                -o-transform-timing-function: ease-out;
